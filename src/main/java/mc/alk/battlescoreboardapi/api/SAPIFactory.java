...
import mc.alk.battlescoreboardapi.scoreboard.SAPIScoreboard;
...
public class SAPIFactory {
     ...
     * @param priority lower means this Objective will be shown in the same slot
     * over another with higher priority
